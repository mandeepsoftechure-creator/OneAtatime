...
const PastDiesease = ({ navigation, route }) => {
    ...
    const handleBackPress = () => {
      ...
      const handleSelectedPastDisease = (selectedItems) => {
        ...
        const fetchProfile = async () => {
            ...
            try {
                ...
                if (profileData.status) {
                    setPersonal_Details(profileData.personal_details_options.past_diseases);
                    setSelectedPastDisease(userData.user.past_diseases_ids || []);
                }
            } catch (error) {
    ...
    const handleSubmit = async () => {
        if (selectedPastDisease.length === 0) {
            Toast.show('Please select Past Diesease', Toast.LONG);
        } else {
            try {
                setLoading(true);
    ...
    const selectPastDisease = selectedPastDisease.length > 0 
    ...
    return (
        ...
        <View style={[BaseStyle.safeAreaView, { backgroundColor: colors.app_background }]}>
            ...
            <CustomHeaderLogin icon_name='left' title="Past Diesease" onBackPress={handleBackPress} />
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ paddingHorizontal: responsiveWidth(5) }}>
                ...
                <View>
                    ...
                    <Text style={[styles.sectionTitle, {color : colors.text_color}]}>Past Diesease</Text>
                        ...
                        <View style={{ marginTop: responsiveHeight(1), marginBottom: responsiveHeight(1) }}>
                            ...
                            <View style={styles.dropdownContainer}>
                                ...
                                <MultiSelect
                                    ...
                                    uniqueKey="id"
                                    onSelectedItemsChange={handleSelectedPastDisease}
                                    ...
                                    displayKey="title"
                                    styleDropdownMenuSubsection={[styles.multiSelectDropdown, selectPastDisease]}
...
export default withNetworkCheck(PastDiesease)
